...
def play_episode():
    ...
    while (done == 0):
        ...
        #TODO put epsilon, one_hot, get_action, replay buffer as part of an 'agent' class to abstract away the specifics
        #as part of play_episode, we should ONLY have state, action, reward, next_state
